...
// Fix: add index signature to controversies type and type all .map() callback parameters
const controversies: Record<
  string,
  {
    title: string;
    icon: any;
...
> = {
  access: {
    ...
    icon: Users,
    description:
      "La privatisation spatiale créé-t-elle une nouvelle forme d'exclusion sociale ?",
    arguments: {
      pour: [
  ...
  environment: {
    ...
    icon: Zap,
    description:
      "Les activités spatiales privées menacent-elles l' environnement terrestre et orbital ?",
    arguments: {
      pour: [
  ...
  governance: {
    ...
    icon: Scale,
    description:
      "Comment réguler l'espace quand les entreprises privées dominent ?",
    arguments: {
      pour: [
  ...
  economics: {
    ...
    icon: DollarSign,
    description:
      "La privatisation spatiale est-elle économiquement viable et équitable ?",
    arguments: {
      pour: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            La privatisation spatiale soulève des questions fondamentales sur
            l'équité, l'environnement, la gouvernance et l'économie. Explorons
            les arguments.
          </p>
        </div>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700">
          <div className="text-center mb-8">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">
              {currentControversy.title}
            </h3>
            <p className="text-slate-300 text-lg">
              {currentControversy.description}
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="p-6 bg-green-500/10 rounded-xl border border-green-500/30">
              ...
              <div className="space-y-3">
                {currentControversy.arguments.pour.map(
            ...
            <div className="p-6 bg-red-500/10 rounded-xl border border-red-500/30">
              ...
              <div className="space-y-3">
                {currentControversy.arguments.contre.map(
                  (arg: string, index: number) => (
                    <div key={index} className="flex items-start gap-3">
          ...
          <div className="p-6 bg-slate-900/50 rounded-xl border border-slate-600">
            ...
            <div className="space-y-2">
              {currentControversy.sources.map(
        ...
        <div className="mt-16 text-center">
          <div className="p-8 bg-gradient-to-r from-violet-500/10 to-purple-600/10 rounded-2xl border border-violet-500/30">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
              Ces enjeux nécessitent un débat démocratique éclairé. L'avenir de
              l'espace ne peut être décidé par quelques entreprises seules.
            </p>
