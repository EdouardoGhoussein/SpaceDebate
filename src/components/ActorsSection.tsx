      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Portrait des organisations qui façonnent l'avenir spatial, 
            entre innovation technologique et controverses éthiques.
          </p>
        </div>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-8">
            <div>
              <h3 className="text-3xl font-bold text-white mb-2">{currentActor.name}</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                {currentActor.achievements.map((achievement, index) => (
            ...
            <div>
              ...
              <div className="space-y-3">
                {currentActor.controversies.map((controversy, index) => (
                  <div key={index} className="flex items-start gap-3 p-3 bg-slate-900/50 rounded-lg">
          ...
          {/* Projects */}
          <div className="mt-8">
            <h4 className="text-xl font-bold text-white mb-4">Projets Actuels</h4>
            <div className="flex flex-wrap gap-3">
              {currentActor.projects.map((project, index) => (
                <span
                  key={index}
          ...
          <div className="mt-8 p-6 bg-gradient-to-r from-slate-700/50 to-slate-600/50 rounded-xl border border-slate-600">
            <h4 className="text-lg font-bold text-white mb-2">Évaluation d'Impact</h4>
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-slate-800/50 rounded-xl border border-slate-700">
              ...
              <div className="text-white font-semibold mb-1">Lancements SpaceX</div>
              <div className="text-slate-400 text-sm">98% de succès</div>
            </div>
            <div className="text-center p-6 bg-slate-800/50 rounded-xl border border-slate-700">
              <div className="text-3xl font-bold text-blue-400 mb-2">3</div>
              <div className="text-white font-semibold mb-1">Lancements Ariane</div>
              <div className="text-slate-400 text-sm">100% de succès</div>
            </div>
            <div className="text-center p-6 bg-slate-800/50 rounded-xl border border-slate-700">
              <div className="text-3xl font-bold text-orange-400 mb-2">6</div>
              <div className="text-white font-semibold mb-1">Vols touristiques</div>
              <div className="text-slate-400 text-sm">Virgin Galactic</div>
            </div>
            <div className="text-center p-6 bg-slate-800/50 rounded-xl border border-slate-700">
              <div className="text-3xl font-bold text-green-400 mb-2">0</div>
              <div className="text-white font-semibold mb-1">Lancements Blue Origin</div>
